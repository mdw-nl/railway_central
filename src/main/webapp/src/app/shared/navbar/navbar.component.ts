...
export class NavbarComponent implements OnInit{
    ...
    private _notifications: Subscription;
    ...
    constructor(location: Location,
        ...
        //TODO: Why does restclientservice need to be public?
        this.location = location;
        this.nativeElement = element.nativeElement;
        this.sidebarVisible = false;
        //_notifications is necessary to trigger change detection.
        // this.restClientService.getNotifications();
        // this._notifications = this.restClientService.emitter.subscribe(notification => {
    ...
    getTitle(){
        ...
        for(var item = 0; item < this.listTitles.length; item++){
            ...
            if(titlee === '/pages/settings'){
                // TODO add function to determine what project was selected.
                return 'Settings'
            }
            if(titlee === '/pages/profile'){
                // TODO add function to determine what project was selected.
                return 'Profile'
            }
    ...
    getNumberOfNotifications(): number {
        console.log("getting number of notifications");
