...
insert into train(id, name, docker_image_url, owner_id, calculation_status) values (1,'statistics', 'dockerurl', 'timh', 2);
...
insert into task(id, train_id, station_id, result, creation_timestamp, calculation_status)
        ...
        TO_TIMESTAMP('2019-07-02 06:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'), 2);
insert into task(id, train_id, station_id, result, creation_timestamp, calculation_status)
        values (4, 1, 4, '{life-the-universe-and-everything: 12}',
        TO_TIMESTAMP('2019-07-02 06:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'), 3);
insert into task(id, train_id, station_id, result, creation_timestamp, calculation_status)
        values (5, 1, 5, '{life-the-universe-and-everything: 32}',
        TO_TIMESTAMP('2019-07-02 06:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'), 4);